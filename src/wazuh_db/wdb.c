...
static const char *SQL_STMT[] = {
    ...
    [WDB_STMT_OSINFO_INSERT] = "INSERT INTO sys_osinfo (scan_id, scan_time, hostname, architecture, os_name, os_version, os_codename, os_major, os_minor,  os_patch, os_build, os_platform, sysname, release, version, os_release, os_display_version, checksum, reference, triaged) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
    [WDB_STMT_OSINFO_INSERT2] = "INSERT OR REPLACE INTO sys_osinfo (scan_id, scan_time, hostname, architecture, os_name, os_version, os_codename, os_major, os_minor,  os_patch, os_build, os_platform, sysname, release, version, os_release, os_display_version, checksum, reference, triaged) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
    ...
    [WDB_STMT_FIM_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM fim_entry WHERE checksum IN (SELECT checksum FROM fim_entry GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_FIM_FILE_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM fim_entry WHERE checksum IN (SELECT checksum FROM fim_entry WHERE type='file' GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_FIM_REGISTRY_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM fim_entry WHERE checksum IN (SELECT checksum FROM fim_entry WHERE type='registry_key' OR type='registry_value' GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_GLOBAL_UPDATE_AGENT_KEEPALIVE] = "UPDATE agent SET last_keepalive = STRFTIME('%s', 'NOW'), connection_status = ?, sync_status = ?, disconnection_time = 0 WHERE id = ?;",
    ...
    [WDB_STMT_SYSCOLLECTOR_PROCESSES_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_processes WHERE checksum IN (SELECT checksum FROM sys_processes GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_PACKAGES_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_programs WHERE checksum IN (SELECT checksum FROM sys_programs GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_HOTFIXES_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_hotfixes WHERE checksum IN (SELECT checksum FROM sys_hotfixes GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_PORTS_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_ports WHERE checksum IN (SELECT checksum FROM sys_ports GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_NETPROTO_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_netproto WHERE checksum IN (SELECT checksum FROM sys_netproto GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_NETADDRESS_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_netaddr WHERE checksum IN (SELECT checksum FROM sys_netaddr GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_NETINFO_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_netiface WHERE checksum IN (SELECT checksum FROM sys_netiface GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_HWINFO_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_hwinfo WHERE checksum IN (SELECT checksum FROM sys_hwinfo GROUP BY checksum HAVING count(*) > 1);",
    ...
    [WDB_STMT_SYSCOLLECTOR_OSINFO_REMOVE_DUPLICATE_ENTRIES] = "DELETE FROM sys_osinfo WHERE checksum IN (SELECT checksum FROM sys_osinfo GROUP BY checksum HAVING count(*) > 1);",
